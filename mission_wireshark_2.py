...
def start_wireshark_capture():
    ...
    return pcap_filename, pdml_filename
...
async def perform_mission():
    pcap_filename, pdml_filename = start_wireshark_capture()
    ...
    await asyncio.sleep(210)  # Adjust the time to the desired length of the mission
