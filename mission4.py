...
async def run_tshark(time_start, count):
    command = "tshark -i any -w capture_{}.pcap".format(count)
...
if __name__ == "__main__":
    ...
    while time.monotonic() < time_stop:
        ...
        loop.create_task(run_tshark(time_start, count))  # Run tshark concurrently
